...
\begin{figure}
    ...
    \caption{(Figure 36 of \texttt{HENS Part 3\_ initial review}.) Percentage of forecasts (IFS) / hindcasts (HENS) during summer 2023 at each grid point at 10-day lead times when the ensemble-maximum 2m air temperature is less than observed (IFS) or analyzed  (HENS).  We define this condition as a ``miss.''  IFS and HENS are subject to miss rates of 7\% and 0.7\%, respectively, of the time.
...
\begin{figure}
    ...
    \caption{(Figure 37 of \texttt{HENS Part 3\_ initial review}.) For summer 2023, the differences between the instantaneous ensemble-maximum 2m air temperature at 10-day lead times and the corresponding temperatures from ERA5 at the verification times of these forecasts/hindcasts.
