...
\includegraphics[width = \textwidth]{Figure_HENS58GEV_calib.png}
    \caption{Calibration of HENS-58-GEV uncertainty intervals relative to HENS (panel a.) along with the width of the 95\% uncertainty interval for the 99.9th percentile estimate in HENS-58-GEV.}
...
\begin{figure}[!h]
    \centering
\includegraphics[width = \textwidth]{Figure_t2m_probContain_0p999_HENS58GEV_vs_HENS.png}
